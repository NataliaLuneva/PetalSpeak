...
en:{
    ...
    collection_love:"Love is expressed in many forms — in bold red roses, in soft peonies, and in delicate blooms that speak without words.",
...
et:{
    ...
    collection_love: "Armastus väljendub paljudes vormides — julgetes punastes roosides, õrnades pojengides ja lilleõites, mis räägivad ilma sõnadeta.",
...
ru:{
    ...
    collection_love: "Любовь выражается по-разному — в ярких красных розах, нежных пионах и цветах, которые говорят без слов.",
